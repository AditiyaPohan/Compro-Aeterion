...
import {
  ShieldCheck, Briefcase, Palette, TrendingUp, Cpu, Server,
  Check, ArrowRight, ArrowUpRight, ChevronRight, type LucideIcon,
} from "lucide-react";
      ...
      <main>
          ...
          <div className="container-x">
            <div className="max-w-2xl">
              <Reveal>
                <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.22em] text-azure">
                  <span className="h-px w-6 bg-gold" />
                  {t.serviceDetail.offeringsLabel}
                </span>
              </Reveal>
              <Reveal index={1}>
                <h2 className="mt-4 text-3xl font-extrabold text-brand sm:text-4xl">
        ...
        <section className="relative overflow-hidden bg-brand-deep py-20 text-white">
          ...
          <div className="container-x relative flex flex-col items-center text-center">
            ...
            <Reveal index={1}>
              <p className="mt-4 max-w-xl text-white/75">{t.serviceDetail.ctaDesc}</p>
            </Reveal>
            <Reveal index={2}>
              <Magnetic strength={0.4}>
                <Link
        ...
        <section className="bg-surface py-20">
          <div className="container-x">
            <h2 className="text-2xl font-extrabold text-brand">{t.serviceDetail.otherLabel}</h2>
