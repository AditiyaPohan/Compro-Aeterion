...
export function Achievements() {
  ...
  return (
    ...
    >
      ...
      <div
        data-speed="0.2"
        className="layer animate-glow pointer-events-none absolute -left-20 top-0 h-72 w-72 rounded-full bg-azure/30 blur-3xl"
      />
      <div
        data-speed="0.2"
        className="layer animate-glow pointer-events-none absolute -right-20 bottom-0 h-72 w-72 rounded-full bg-gold/15 blur-3xl"
      />
