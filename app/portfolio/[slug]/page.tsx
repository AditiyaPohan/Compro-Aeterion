      ...
      <main>
          ...
          <div className="container-x grid gap-12 lg:grid-cols-[1.5fr_1fr] lg:gap-16">
            ...
            <Reveal index={2}>
              <div className="rounded-[2rem] bg-surface p-8 shadow-card">
                <h3 className="text-lg font-bold text-brand">Scope of work</h3>
        ...
        <section className="bg-surface py-20">
          <div className="container-x">
            <h2 className="text-2xl font-extrabold text-brand">More projects</h2>
            <div className="mt-8 grid gap-6 sm:grid-cols-3">
              {others.map((p) => (
                ...
                >
                  ...
                  <div className="p-5">
                    <h3 className="text-sm font-bold text-brand group-hover:text-azure">
                      {p.title}
                    </h3>
                  </div>
                </Link>
